...
import { Users, Shield, DollarSign, TrendingUp, Loader2 } from "lucide-react";
...
// Salary calculation: 5% of monthly income generated
const SALARY_PERCENTAGE = 0.05;
  ...
  const fetchUsers = async () => {
    try {
      ...
      const usersWithRoles: UserWithRole[] = (profiles || []).map((profile) => {
        ...
        // Calculate estimated salary (5% of monthly income)
        const estimatedSalary = monthlyIncome * SALARY_PERCENTAGE;
      ...
      <div className="space-y-6">
          ...
          <Card className="stat-card">
            <CardHeader className="pb-2">
              <div className="flex items-center gap-2">
                ...
                <CardDescription>Est. Total Salaries (5%)</CardDescription>
              </div>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Assign roles and track revenue generated by each user. Salary is calculated as 5% of monthly income recorded.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="text-right">Est. Salary (5%)</TableHead>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Estimated monthly salary is calculated as <strong>5%</strong> of the total income 
                  recorded by each user in the current month ({format(new Date(), "MMMM yyyy")}). 
                  This provides a performance-based incentive for staff.
                </p>
              </div>
            </div>
          </CardContent>
